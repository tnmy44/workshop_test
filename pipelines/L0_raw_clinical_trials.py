...
with DAG(Schedule = Schedule):
    model_L0_raw_clinical_trials_clinical_trial_details = Task(
        task_id = "model_L0_raw_clinical_trials_clinical_trial_details", 
        component = "Model", 
        modelName = "model_L0_raw_clinical_trials_clinical_trial_details"
    )
    ...
    l0_raw_clinical_trials.out >> model_L0_raw_clinical_trials_clinical_trial_details.in_0
    model_L0_raw_clinical_trials_clinical_trial_details.out_0 >> clean_clinical_trial_data.in0
