...
with DAG(Schedule = Schedule):
    ...
    model_test2_clean_clinical_trial_data = Task(
        task_id = "model_test2_clean_clinical_trial_data", 
        component = "Model", 
        modelName = "model_test2_clean_clinical_trial_data"
    )
    l0_raw_clinical_trials.out >> model_test2_clean_clinical_trial_data.in_0
